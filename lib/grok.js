  ...
  "preparation_items": [
    {
      ...
      "container": "Half Deep/Half Shalow/Black Bowl/other",
...
4. Container guidelines:
  ...
  - IMPORTANT: All capacity calculations should account for 10% headspace - containers should never be filled 100% to prevent spillage
5. Fill Level must specify if container is Full or partially filled
   - "Full" means filled to 90% capacity (leaving 10% headspace)
   - Partial fill levels (1/4, 1/2, 3/4) should be calculated based on 90% maximum capacity
